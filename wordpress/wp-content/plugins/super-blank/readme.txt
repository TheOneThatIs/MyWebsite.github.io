...
<h4>SUPER BLANK MAKES IT SUPER EASY TO BUILD YOUR WEBSITE</h4>
...
<iframe width="600" height="320" src="https://www.youtube.com/embed/37GGkoPNeXE?si=v-htaYs01_YlAjDK" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
2. Search for 'Super Blank'
3. Activate the plugin from your Plugins page.

= From WordPress.org =

1. Download 'Super Blank'.
2. Upload the 'Super Blank' directory to your '/wp-content/plugins/' directory, using your favorite method (ftp, sftp, scp, etc...)
3. Activate 'Super Blank' from your Plugins page.
4. Go to any page in editor mode and open the inserter.
5. Select Patterns -> All.
6. Now you can select and insert the new patterns to your website.

== Screenshots ==

1. Super Blank Import Website Page
2. Super Blank Home Page
3. Elementor Edit Area
4. Super Blank Pages Collection
...
= 1.0.7 =
* Fixed headings and buttons font issue

= 1.0.6 =
* Fixed WPForms input border colors. Gutenberg patterns issues fixed
...
= 1.0.3 =
* Added Elementor Sections and Pages
...
All images in this plugin are licensed under the GPLv2 license. This means that you are free to use, modify, and distribute them as you wish.
